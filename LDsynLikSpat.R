...
#==================
nameSimul<-"allwithPrior" # see LP <- LL in Model() # used by sec_launch.sh to give a name to the output folder
Nrep=50
set.seed(1)
...
#============================
	...
	write.table(Monitor[1:min(numit, nbsimul)], "thetasamplescomplete.txt", sep="\t",append=FALSE,col.names=FALSE,row.names=FALSE)
	write.table(accepts[1:min(numit, nbsimul)], "acceptsamplescomplete.txt", sep ="\t",append=FALSE,col.names=FALSE,row.names=FALSE)
